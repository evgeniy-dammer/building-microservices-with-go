...
type CurrencyClient interface {
	...
	// SubscribeRates is a bi-directional streaming subscriber
...
func (c *currencyClient) SubscribeRates(ctx context.Context, opts ...grpc.CallOption) (Currency_SubscribeRatesClient, error) {
	stream, err := c.cc.NewStream(ctx, &Currency_ServiceDesc.Streams[0], "/protos.Currency/SubscribeRates", opts...)
	if err != nil {
		return nil, err
	}
